...
// 💰 PRICE SETTINGS
let price_per_1k = 110; // ₹81 per 1000 Telegram members
...
let summary =
  "<b>📦 Order Summary</b>\n\n" +
  "📸 <b>Service:</b> Telegram Non-Drop Members 🚀\n" +
  "🔢 <b>Quantity:</b> " + qty + "\n" +
  "🔗 <b>Group / Channel Link:</b>\n" + link + "\n\n" +
...
let buttons = {
  inline_keyboard: [
    [
      { text: "✅ Confirm", callback_data: "confirm_order_tg_members" },
