/*CMD
  command: /ig_indian_followers_link
  help: 
  need_reply: true
  auto_retry_time: 
...
// 💰 PRICE SETTINGS
let price_per_1k = 98; // ₹81 per 1000 Indian followers
...
let summary =
  "<b>📦 Order Summary</b>\n\n" +
  "📸 <b>Service:</b> Instagram Indian Followers 🇮🇳\n" +
  "🔢 <b>Quantity:</b> " + qty + "\n" +
  "🔗 <b>Profile Link:</b>\n" + link + "\n\n" +
...
let buttons = {
  inline_keyboard: [
    [
      { text: "✅ Confirm", callback_data: "confirm_order_ig_ind_followers" },
