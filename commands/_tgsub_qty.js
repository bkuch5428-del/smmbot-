...
if (!isNaN(qty) && qty > 0) {
  ...
  Bot.sendMessage(
    "👥 *Telegram Channel Link Required*\n\n" +
    "🔗 Please send the *public Telegram channel link* 👇\n" +
    "_Private channel ya invite-only link accept nahi hoga_",
    { parse_mode: "Markdown" }
  );
